...
def create_document():
    ...
    run_title = p_title.add_run("🛡️ AegisSOC Multi-Node Distributed SIEM System\nComplete End-to-End Project Documentation")
    ...
    run_sub = p_sub.add_run("Verified Live Multi-Node Test: WIN-RJCSG0BSFFA (192.168.0.181) -> SIEM Server (192.168.0.128:8000)")
    ...
    h1 = doc.add_heading("1. Executive Summary & Verified Multi-Node Live Test", level=1)
    ...
    doc.add_heading("Verified Live Network Agent Connection Log:", level=2)
    doc.add_paragraph(
        " • Target Hostname: WIN-RJCSG0BSFFA\n"
        " • Agent ID: AGENT-WIN-RJCSG0BSFFA\n"
        " • Target Local IP: 192.168.0.181\n"
        " • SIEM Server URL: http://192.168.0.128:8000\n"
        " • Status: Successfully registered agent & streaming live telemetry (Events 5156, 1102, 4624, 4688)."
    )
